...
% this file is for finding the worse/optimal parameter for PC
...
parfor k = 1:length(lambda)
	...
	disp(['when lambda is:' num2str(lambda(k)) ',the worst policy is:' num2str(v1_opt(i_WORST)) ',' num2str(v2_opt(j_WORST))]);
end
%% plot section
